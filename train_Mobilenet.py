...
def _main():
    train_path = 'data/COCO_train2014.txt'
    val_path = 'data/COCO_val2014.txt'
    log_dir = 'logs/'
    ...
    if is_tiny_version:
        ...
        model = create_model(input_shape, anchors, num_classes,load_pretrained=True,
                             weights_path='logs/ep015-loss13.687-val_loss14.562.h5',
...
def create_model(input_shape, anchors, num_classes, load_pretrained=False,weights_path="",freeze_body=2,
            ):
